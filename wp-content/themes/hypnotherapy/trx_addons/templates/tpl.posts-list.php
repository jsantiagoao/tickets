...
$trx_addons_post_date  = sprintf( esc_html__('%s ago', 'hypnotherapy'), human_time_diff(get_the_time('U')) );
...
if ($trx_addons_show_image) {
	$trx_addons_post_thumb = get_the_post_thumbnail($trx_addons_post_id, trx_addons_get_thumb_size('recentpost'), array(
		'alt' => get_the_title()
	));
